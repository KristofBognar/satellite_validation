function [ spv, temperature, theta, lat, lon ] = match_DMP_OSIRIS( ft_meas, year, species, alt )
%MATCH_DMP_OSIRIS Returns DMPs for given OSIRIS measurement
%
% INPUT
...
for yy=years
    ...
    disp_str=['DMP matching for ' num2str(yy) ' OSIRIS data'];
...
% %           '_DMP_table_' num2str(yy) '.mat']);
    load(['/home/kristof/work/DMP/DMP_OSIRIS/OSIRIS_' species...
          '_DMP_table_' num2str(yy) '.mat']);
