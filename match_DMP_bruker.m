function [ spv, temperature, theta, lat, lon ] = match_DMP_bruker( ft_meas, year, alt )
%MATCH_DMP_bruker Returns DMPs for given Bruker measurement
%
% INPUT
...
for yy=years
    ...
    disp_str=['DMP matching for ' num2str(yy) ' Bruker data'];
    ...
    try
        load(['/home/kristof/work/DMP/DMP_bruker/bruker_DMP_table_' num2str(yy) '.mat']);
    catch
        continue
    end
